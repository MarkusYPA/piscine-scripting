def clean_list(stuff: list[str]) -> list[str]:
    ...
    # x Remove all spaces at the beginning and at the end of the string (but not between words).
    # x Capitalize only the first letter of the string (all other letters must be lowercase).
